...
# also make sure that you are added to the Atrix organization on buf
...
buf mod update $AtrixPROTO

# then, push the Atrix proto module and documentation 
buf push $AtrixPROTO

# two commit addresses should be printed to the command line
# the Atrix documentation will have links to the third party documentation
