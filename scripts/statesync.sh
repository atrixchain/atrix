...
# Initialize chain.
Atrixd init test --chain-id Atrix_9000-2

# Get Genesis
wget https://archive.Atrix.org/mainnet/genesis.json
mv genesis.json ~/.Atrixd/config/

wget -O ~/.Atrixd/config/adrbook.json https://snapshot.notional.ventures/Atrix/addrbook.json
...
export AtrixD_P2P_MAX_NUM_INBOUND_PEERS=200
export AtrixD_P2P_MAX_NUM_OUTBOUND_PEERS=200
export AtrixD_STATESYNC_RPC_SERVERS="https://Atrix-rpc.polkachu.com:443,https://rpc-Atrix-ia.notional.ventures:443"
