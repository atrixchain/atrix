...
func init() {
	proto.RegisterType((*InflationDistribution)(nil), "Atrix.inflation.v1.InflationDistribution")
	proto.RegisterType((*ExponentialCalculation)(nil), "Atrix.inflation.v1.ExponentialCalculation")
}
