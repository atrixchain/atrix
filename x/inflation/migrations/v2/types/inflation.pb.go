...
// source: Atrix/inflation/v1/inflation.proto
...
// The initial V2InflationDistribution can be calculated from the Atrix Token
// Model like this:
...
func init() {
	proto.RegisterType((*V2InflationDistribution)(nil), "Atrix.inflation.v1.V2InflationDistribution")
	proto.RegisterType((*V2ExponentialCalculation)(nil), "Atrix.inflation.v1.V2ExponentialCalculation")
}

func init() {
	proto.RegisterFile("Atrix/inflation/v1/inflation.proto", fileDescriptor_d064cb35c3ff7df8)
}
