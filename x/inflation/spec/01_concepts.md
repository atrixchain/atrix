...
The Atrix Token Model outlines how the Atrix network is secured through a
...
issue 1 billion Atrix tokens within the first 4 years.
...
daily provision (`epochProvison`) of Atrix tokens is minted and allocated to staking rewards,
