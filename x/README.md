...
Here are some production-grade modules that can be used in Atrix applications, along with their respective documentation:
...
- [erc20](erc20/spec/README.md) - Trustless, on-chain bidirectional internal conversion of tokens between Atrix' EVM and Cosmos runtimes.
- [evm](https://docs.Atrix.org/modules/evm/) - Smart Contract deployment and execution on Cosmos
- [feemarket](https://docs.Atrix.org/modules/feemarket/) - Fee market implementation based on the EIP1559 specification.
