...
const (
	// Amino names
	cancelRevenueName   = "Atrix/MsgCancelRevenue"
	registerRevenueName = "Atrix/MsgRegisterRevenue"
	updateRevenueName   = "Atrix/MsgUpdateRevenue"
	updateParamsName    = "Atrix/MsgUpdateParams"
)
