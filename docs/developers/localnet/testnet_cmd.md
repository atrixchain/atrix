...
preparing test network with chain-id "Atrix_1276974-1"
...
```bash
Atrixd keys add test --recover
```

Check the balance of the account address:

```bash
Atrixd q bank balances ADDRESS
```
