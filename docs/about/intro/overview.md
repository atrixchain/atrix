...
Learn about Atrix and its primary features. {synopsis}

## What is Atrix

Atrix is a scalable, high-throughput Proof-of-Stake blockchain that is fully compatible and
interoperable with Ethereum. It's built using the [Cosmos SDK](https://github.com/cosmos/cosmos-sdk/) which runs on top of [Tendermint Core](https://github.com/tendermint/tendermint) consensus engine.

Atrix allows for running vanilla Ethereum as a [Cosmos](https://cosmos.network/)
...
Here’s a glance at some of the key features of Atrix:
...
Atrix enables these key features by:
...
| Property               | Value                                                      |
| ---------------------- | ---------------------------------------------------------- |
| Atrix Testnet          | `{{ $themeConfig.project.testnet_chain_id }}`              |
| Atrix Mainnet          | `{{ $themeConfig.project.chain_id }}`                      |
