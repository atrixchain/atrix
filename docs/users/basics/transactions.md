...
Learn more about transactions on Atrix {synopsis}
...
<!-- 
TODO: explain what transactions are on Atrix and blockchains. 
...
<!-- TODO: explain which transactions types does Atrix support (i.e modules and changes) and provide a few examples. -->
...
Atrix supports the following Ethereum transactions.
