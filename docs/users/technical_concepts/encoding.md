...
Learn about the encoding formats used on Atrix. {synopsis}
...
previous versions, specially for client encoding and signing with Ledger devices. Atrix does not
...
allows for quick reconstruction of encoded data. Atrix uses RLP to encode/decode Ethereum
