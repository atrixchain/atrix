...
If you want to open a PR on the Cosmos SDK to update the documentation, please follow the guidelines in the [`CONTRIBUTING.md`](https://github.com/Atrix/Atrix/tree/main/CONTRIBUTING.md#updating-documentation)
...
The documentation for Atrix is hosted at [docs.Atrix.org](https://docs.Atrix.org/)

built from the files in this (`/docs`) directory for
[master](https://github.com/Atrix/Atrix/tree/main/docs).
