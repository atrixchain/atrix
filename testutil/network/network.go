...
func DefaultConfig() Config {
	...
	return Config{
		...
		ChainID:           fmt.Sprintf("Atrix_%d-1", tmrand.Int63n(9999999999999)+1),
		NumValidators:     4,
		BondDenom:         "aAtrix",
...
// NewAppConstructor returns a new Atrix AppConstructor
...
func New(l Logger, baseDir string, cfg Config) (*Network, error) {
	...
	for i := 0; i < cfg.NumValidators; i++ {
		...
		nodeDir := filepath.Join(network.BaseDir, nodeDirName, "Atrixd")
		clientDir := filepath.Join(network.BaseDir, nodeDirName, "Atrixcli")
