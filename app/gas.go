...
var (
	// MainnetMinGasPrices defines 20B aAtrix (or atAtrix) as the minimum gas price value on the fee market module.
	// See https://commonwealth.im/Atrix/discussion/5073-global-min-gas-price-value-for-cosmos-sdk-and-evm-transaction-choosing-a-value for reference
